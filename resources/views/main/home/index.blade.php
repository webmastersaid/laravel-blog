            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        ...
                        <div class="mb-1 text-body-secondary">{{$post->parseDate()}}</div>
                        <p class="card-text mb-auto">{{ $post->content }}</p>
                        <a href="{{ route('main.post.show', $post->id) }}"
                    ...
                    <div class="col-auto d-none d-lg-block">
                        @if ($post->preview_image)
                            <img src="{{ Storage::url($post->preview_image) }}" alt="{{ $post->title }}" width="200" height="250">
                        @else
                                ...
                                <a class="d-flex flex-column flex-lg-row gap-3 align-items-start align-items-lg-center py-3 link-body-emphasis text-decoration-none border-top"
                                    ...
                                    @if ($post->preview_image)
                                        <img src="{{ Storage::url($post->preview_image) }}"
                                            alt="{{ $post->title }}" width="118" height="96">
                                    @else
