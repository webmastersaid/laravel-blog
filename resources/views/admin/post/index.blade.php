        ...
        <table class="table table-striped text-center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="dropdown">
                            <span type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list text-secondary" viewBox="0 0 16 16">
                    ...
                    <td>
                        <a href="{{ route('admin.post.show', $post->id) }}" class="text-link">
                            {{ $post->title }}
                        </a>
                    </td>
                    <td>{{ $post->content }}</td>
                    <td><img src="{{ Storage::url($post->preview_image) }}" alt="{{ $post->title }}" height="24"></td>
                    <td><img src="{{ Storage::url($post->detail_image) }}" alt="{{ $post->title }}" height="24"></td>
