    ...
    <div class="row">
        <form action="{{ route('admin.user.update', $user->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nameFormControlInput" name="name" placeholder="User name" value="{{ old('name', $user->name) }}">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="emailFormControlInput" name="email" placeholder="Email" value="{{ old('email', $user->email) }}">
                @error('email')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
